...
| W8: source drift between the 3 copies | `ssh $PROTON_MCP_SSH_HOST "md5sum /home/preston/docker/proton-email-mcp/proton_email_server.py <docker-root>/librechat-stack/proton-email-mcp/proton_email_server.py"` vs `md5 -q /Users/prestonbernstein/dev/proton-email-mcp/proton_email_server.py` |
